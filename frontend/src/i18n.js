  ...
  en: {
    translation: {
      ...
      terms: {
        ...
        acceptance:
          "By using our services at beliakun, you agree to the following terms and conditions without exception.",
        transaction: {
        ...
        services:
          "beliakun provides digital game services such as top-ups, account sales, game items, and game-related services. We reserve the right to update or terminate services at any time.",
        user_data:
          "We use your data only for order processing. We do not share your data unless required by law. See our Privacy Policy for details.",
        user_responsibility:
          "You are fully responsible for the data provided. beliakun is not liable for losses due to user error.",
        modification:
          "Terms may change at any time. Updates will be shown on this page.",
      ...
      privacy: {
        ...
        last_updated: "Last updated: June 18, 2025",
        intro:
          "This page explains how we collect, use, and protect your personal information on beliakun.",
        collected: {
        ...
        security: {
          title: "Data Security",
          description:
            "We apply strict internal controls and encrypted communication to ensure your data remains protected.",
        },
        rights: {
          title: "Your Rights",
          items: [
        ...
        cookies: {
          title: "Cookies",
          description:
            "Our website uses cookies to enhance performance and personalize your experience. You can disable them in your browser settings.",
        },
        changes: {
      ...
      wishlist_subtitle: "Save your favorite products to buy later.",
      ...
      empty_wishlist_desc:
        "Explore the catalog and add products you like.",
      ...
      checkout: {
        ...
        phone: "Phone number",
        phoneHint:
          "Enter the number without leading 0, e.g. 81234567890",
        ...
        // validation helper
        fillAll: "Please complete all required inputs.",
        phoneReq: "Phone number is required",
        addrReq: "Address is required",
        methodReq: "Please choose a payment method",
        invalidPhone: "Phone number is invalid.",
        chooseBank: "Choose Payment Method",
        secure: "Payments are secure & encrypted.",
        shopNow: "Shop Now",
      ...
      payment: {
        ...
        pending_msg:
          "Your payment is still pending. Please complete the payment before expiration.",
        expires: "Expires in",
        total: "Total Amount",
  ...
  id: {
    translation: {
      ...
      terms: {
        ...
        acceptance:
          "Dengan menggunakan layanan beliakun, Anda dianggap telah menyetujui semua syarat dan ketentuan berikut ini tanpa pengecualian.",
        transaction: {
        ...
        services:
          "beliakun menyediakan layanan digital game seperti top up, jual beli akun, item game, dan layanan terkait lainnya. Kami berhak mengubah atau menghentikan layanan sewaktu-waktu.",
        user_data:
          "Data Anda digunakan hanya untuk memproses pesanan. Kami tidak membagikan data Anda kecuali diwajibkan oleh hukum. Baca selengkapnya di Kebijakan Privasi.",
        user_responsibility:
          "Pengguna bertanggung jawab atas data yang diberikan. beliakun tidak bertanggung jawab atas kerugian akibat kesalahan pengguna.",
        modification:
          "Syarat & Ketentuan dapat berubah sewaktu-waktu dan akan diperbarui di halaman ini.",
        contact:
          "Hubungi kami jika ada pertanyaan terkait syarat & ketentuan ini.",
        contact_info: {
          email: "Email: admin@beliakun.com",
          whatsapp: "WhatsApp: +62 812-3456-7890",
          website: "Website: https://beliakun.com",
      ...
      privacy: {
        ...
        last_updated: "Terakhir diperbarui: 18 Juni 2025",
        intro:
          "Halaman ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi data pribadi Anda di beliakun.",
        collected: {
        ...
        security: {
          title: "Keamanan Data",
          description:
            "Kami menggunakan kontrol internal yang ketat dan komunikasi terenkripsi untuk menjaga keamanan data Anda.",
        },
        rights: {
          title: "Hak Anda",
          items: [
        ...
        cookies: {
          title: "Cookies",
          description:
            "Situs kami menggunakan cookies untuk meningkatkan performa dan personalisasi pengalaman Anda. Anda dapat menonaktifkan cookies di pengaturan browser.",
        },
        changes: {
          title: "Perubahan Kebijakan",
          description:
            "Kami dapat memperbarui kebijakan ini sewaktu-waktu. Semua perubahan akan diumumkan di halaman ini.",
        },
        contact: {
          title: "Hubungi Kami",
          email: "Email: admin@beliakun.com",
      ...
      // Wishlist
      wishlist_title: "Wishlist",
      wishlist_subtitle: "Simpan produk favoritmu untuk dibeli nanti.",
      ...
      empty_wishlist_title: "Daftar keinginanmu masih kosong",
      empty_wishlist_desc:
      ...
      checkout: {
        title: "Checkout",
        subtitle: "Lengkapi data dan pilih metode pembayaran.",
        formSection: "Form Pemesanan",
        yourDetails: "Data Pemesan",
        phone: "Nomor HP",
        phoneHint:
        ...
        // validation helper
        fillAll: "Silakan lengkapi semua input terlebih dahulu.",
        phoneReq: "Nomor telepon wajib diisi",
        addrReq: "Alamat wajib diisi",
        methodReq: "Pilih metode pembayaran",
        invalidPhone: "Nomor telepon tidak valid.",
        chooseBank: "Pilih Metode Pembayaran",
        secure: "Pembayaran aman & terenkripsi.",
        shopNow: "Belanja Sekarang",
        emptyCart: "Keranjang masih kosong. Silakan pilih produk terlebih dahulu.",
      },
      ...
      payment: {
        ...
        pending_msg:
          "Pembayaran Anda masih pending. Silakan selesaikan sebelum waktu habis.",
        ...
        footer_msg:
          "Silakan jangan tutup halaman ini sampai pembayaran selesai.",
      },
      ...
      home_page_description:
        "Temukan produk terbaik dengan harga yang tak tertandingi.",
      ...
      product_no_results:
        "Tidak ada produk yang ditemukan sesuai kriteria.",
...
i18n.use(initReactI18next).init({
  ...
  // Optional: plural rules already covered by keys (items_count/items_count_plural)
});
